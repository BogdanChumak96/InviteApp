...
export const User = ({ user, onClickInvite, isInvite }) => (
  <li>
    <div>
    ...
    <img className="action" onClick={() => onClickInvite(user.id)} src={isInvite ? '/assets/minus.svg' : '/assets/plus.svg'} alt="Action" />
  </li>
);
